public class Main
{
    public static void main(String[] args)
    {
        ...
        RentalOptionsDecorator lowerDepositHigherRentalPrice = new LowerDepositHigherRentalPrice(agreement2);
        RentalOptionsDecorator tripleAOption = new TripleADecorator(agreement2);
        RentalOptionsDecorator extraKmDecorator = new ExtraKilometerDecorator(agreement2);

        agreement2.addOptionsToAgreement(childSeatOption);
        agreement2.addOptionsToAgreement(towBarOption);
        agreement2.addOptionsToAgreement(lowerDepositHigherRentalPrice);
        agreement2.addOptionsToAgreement(higherDepositLowerRentalPrice);
